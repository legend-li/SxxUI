 ...
 ```js
   {
       ...
       type: '', //组件的类型，可选值：'datetime'、'date'、'dateYM'、'dateMD'、'time'、'timeHM'、'timeMS'、默认值：'datetime'，[type: String]，可选
       
       defaultDatetime: '', // 组件默认选中日期/时间，默认值为当前日期/时间，[type: String]，可选
                            // 格式为：yyyy-MM-dd HH:mm:ss或yyyy-MM-dd或HH:mm:ss或yyyy-MM或MM-dd或HH:mm或mm:ss
       ...
       startHour: '', // 小时的最小可选值，默认为：0，[type: Number]，可选
                      // 注：type为'time'、'timeHM'、'timeMS'时有效
